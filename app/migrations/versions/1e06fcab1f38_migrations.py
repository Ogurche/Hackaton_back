...
Revision ID: 1e06fcab1f38
Revises: 
Create Date: 2023-09-18 10:14:29.235355
...
def downgrade() -> None:
    ...
    sa.Column('card_num', sa.INTEGER(), autoincrement=True, nullable=False),
