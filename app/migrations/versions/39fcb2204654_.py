...
Revision ID: 39fcb2204654
Revises: 
Create Date: 2023-09-19 14:30:14.697593
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='snils_user_id_fkey'),
    ...
    sa.Column('card_num', sa.BIGINT(), autoincrement=True, nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='card_user_id_fkey'),
    sa.PrimaryKeyConstraint('card_num', name='card_pkey')
    )
    op.create_table('promo_categories',
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('promo_categories_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.Column('user_info_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['user_info_id'], ['user_info.id'], name='auth_user_info_id_fkey'),
    sa.PrimaryKeyConstraint('login', name='auth_pkey')
    )
    op.create_table('transport',
    sa.Column('id', sa.SMALLINT(), server_default=sa.text("nextval('transport_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('promo_info_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.Column('transport_id', sa.SMALLINT(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['conductor_id'], ['users.id'], name='session_conductor_id_fkey'),
